...
- Upstream: `~/dev/waylandteams/` at HEAD as of 2026-05-18 evening (W0 of the team-blitz workstream)
- Files copied:
  - `contributes/assistants.json` → `./assistants.json` (44 entries: 24 launchers with `kind: 'team'` + 20 specialists with `kind: 'specialist'`)
