...
const SKILLS_MARKET_DETAILS_ZH = 'https://github.com/TradeCanyon/Wayland/discussions/1326';
const SKILLS_MARKET_DETAILS_EN = 'https://github.com/TradeCanyon/Wayland/discussions/1325';
