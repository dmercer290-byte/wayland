...
// -----------------------------------------------------------------------
// TC-1: Block syntax parsing
// -----------------------------------------------------------------------

// TC-1.2: Block multi-line command
#[test]
...
// TC-1.3: Block with surrounding content - full_match covers the entire block
#[test]
...
// TC-1.5: No Block content -> zero matches
#[test]
...
// TC-1.6: Plain code blocks do not match (no `!`)
#[test]
...
// TC-1.7: Block with empty content
#[test]
...
// -----------------------------------------------------------------------
// TC-2: Inline syntax parsing
// -----------------------------------------------------------------------

// TC-2.2: Inline preceded by space - 1 match
#[test]
...
// TC-2.3: Multiple Inline matches
#[test]
...
// TC-2.4: No space prefix does not match (D-1 deviation)
// Rust regex does not support lookbehind; should not match when prefix is non-whitespace
#[test]
fn tc_2_4_no_prefix_not_matched() {
    // "x!`cmd`" - x is not a space/line-start, so this should not match
    let content = "x!`cmd`";
    let matches = extract_shell_matches(content);
    assert_eq!(
        matches.len(),
...
// TC-2.6: Inline command containing spaces
#[test]
...
// -----------------------------------------------------------------------
// TC-3: Block + Inline mixed
// -----------------------------------------------------------------------

// TC-3.1: Both Block and Inline present
#[test]
...
// TC-3.2: Block contains Inline syntax - Block takes precedence; inner Inline is not matched separately (D-2 deviation)
#[test]
...
// -----------------------------------------------------------------------
// TC-4: execute_command - command execution
// -----------------------------------------------------------------------

// TC-4.1: Successful command
#[tokio::test]
...
// TC-4.2: Command produces stdout
#[tokio::test]
...
// TC-4.3: Command produces stderr
#[tokio::test]
...
// TC-4.4: Command fails with no output -> Err (D-3 deviation: still returns Ok when output is present)
#[tokio::test]
...
// TC-4.4b: Command fails but produces output -> Ok (D-3 deviation verification)
#[tokio::test]
...
// TC-4.5: cwd argument takes effect
#[tokio::test]
...
// TC-4.6: Command output is empty -> output is empty string
#[tokio::test]
...
// TC-4.7: Command does not exist -> Err
#[tokio::test]
...
// TC-5.5: Trailing newline in stdout is trimmed
#[test]
...
// TC-6.1: MCP skill -> skip execution, return content unchanged
#[tokio::test]
...
// TC-6.2: No shell commands -> content unchanged
#[tokio::test]
...
// TC-6.3: Block command substitution - full_match replaced with output
#[tokio::test]
...
// TC-6.4: Inline command substitution - leading whitespace preserved (D-1 deviation)
#[tokio::test]
...
// TC-6.5: Multiple commands executed in parallel - both substituted
#[tokio::test]
...
// TC-6.7: Back-to-front substitution - earlier replacements do not corrupt later positions
#[tokio::test]
...
// TC-6.8: Block command + surrounding text preserved
#[tokio::test]
...
// TC-7.1: CommandFailed message contains pattern
#[test]
...
// TC-15.1: content is an empty string
#[tokio::test]
...
// TC-15.3: Command contains special characters (quotes, pipes)
#[tokio::test]
...
// TC-15.4: Command contains newlines (multi-line block)
#[tokio::test]
...
// TC-15.6: Same command appears multiple times
#[tokio::test]
