...
use serde_json::json;
use wcore_agent::plan::prompt::plan_mode_instructions;
use wcore_agent::plan::tools::{EnterPlanModeTool, ExitPlanModeTool};
use wcore_protocol::events::ToolCategory;
use wcore_tools::Tool;
use wcore_tools::registry::ToolRegistry;
use wcore_types::skill_types::PlanModeTransition;
...
fn tc_3_6_e2e_02_plan_mode_and_compaction_independent() {
    use wcore_agent::compact::micro::microcompact;
    use wcore_agent::plan::state::PlanState;
