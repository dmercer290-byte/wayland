...
mod tests {
    ...
    // -----------------------------------------------------------------------
    // TC-1.x: McpResource deserialization [black-box]
    // -----------------------------------------------------------------------

    #[test]
    fn tc_1_1_mcp_resource_all_fields() {
        // [black-box] TC-1.1: McpResource complete deserialization with all optional fields
        let json_str = r#"{
            "uri": "skill://my-skill",
            "name": "My Skill",
    ...
    fn tc_1_2_mcp_resource_uri_only() {
        // [black-box] TC-1.2: McpResource with only the required uri field - all options are None
    ...
    fn tc_1_3_mcp_resource_mime_type_camel_case_mapping() {
        // [white-box] TC-1.3: JSON field "mimeType" (camelCase) maps to Rust field mime_type via serde rename
    ...
    fn tc_1_3b_mcp_resource_mime_type_snake_case_absent() {
        // [white-box] TC-1.3b: snake_case "mime_type" key is not accepted - mime_type stays None
    ...
    // -----------------------------------------------------------------------
    // TC-1.4: ResourcesListResult deserialization [black-box]
    // -----------------------------------------------------------------------

    #[test]
    fn tc_1_4_resources_list_result_multiple() {
        // [black-box] TC-1.4: ResourcesListResult with multiple resources
        let json_str = r#"{
            "resources": [
                {"uri": "skill://skill-a"},
    ...
    fn tc_1_5_resources_list_result_empty() {
        // [black-box] TC-1.5: ResourcesListResult with empty resources array
    ...
    // -----------------------------------------------------------------------
    // TC-1.6/1.7/1.8: ResourcesReadResult and ResourceContent [black-box]
    // -----------------------------------------------------------------------

    #[test]
    fn tc_1_6_resources_read_result_with_text() {
        // [black-box] TC-1.6: ResourcesReadResult with text content
        let json_str = r#"{
            "contents": [
                {
                    "uri": "skill://my-skill",
    ...
    fn tc_1_7_resource_content_no_text_field() {
        // [black-box] TC-1.7: ResourceContent without text (blob resource) - text is None
    ...
    fn tc_1_8_resource_content_no_mime_type() {
        // [black-box] TC-1.8: ResourceContent without mimeType - mime_type is None
    ...
    fn tc_1_wb_resource_content_mime_type_camel_case() {
        // [white-box] ResourceContent.mimeType uses same serde rename as McpResource
    ...
    fn tc_1_wb_resources_read_result_multiple_contents() {
        // [white-box] TC: read_resource uses find_map - multiple contents, only first text is used
